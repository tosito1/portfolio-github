...
const projects = [
  {
    ...
    subtitle: "Sistema WebAuth & FIDO",
    description: "Sistema seguro de autenticación de dos factores utilizando estándares WebAuth y FIDO para prevenir phishing y suplantación de identidad en entornos corporativos.",
    tags: ["WebAuth", "FIDO2", "Ciberseguridad", "Node.js"],
    icon: "shield"
  },
  {
    title: "Hexápodo de Vigilancia con IA",
    subtitle: "Robot Autónomo Inteligente",
    description: "Robot hexápodo con Raspberry Pi 4 equipado con visión artificial, movimiento autónomo y reconocimiento de voz para tareas de vigilancia.",
    tags: ["Python", "OpenCV", "Raspberry Pi", "ML"],
    icon: "robot"
  },
  {
    title: "Chat & Ubicación en Tiempo Real",
    subtitle: "Aplicación Android",
    description: "Aplicación móvil para Android con mensajería instantánea y compartición de geolocalización en tiempo real usando Firebase.",
    tags: ["Kotlin", "Firebase", "Android", "Maps API"],
    icon: "chat"
  },
  {
    title: "Gestión de Socios & Notificaciones",
    subtitle: "Sistema de Gestión Integral",
    description: "Aplicación con roles diferenciados, sistema de autenticación robusto y notificaciones push dinámicas para gestión de organizaciones.",
...
const renderSocialLinks = () => `
  <ul class="example-2">
    <li class="icon-content">
      <a href="${userData.contact.linkedin}" aria-label="LinkedIn" data-social="linkedin" target="_blank">
    ...
    <li class="icon-content">
      <a href="${userData.contact.github}" aria-label="GitHub" data-social="github" target="_blank">
        <div class="filled"></div>
        ${icons.github}
      </a>
    ...
    <li class="icon-content">
      <a href="${userData.contact.whatsapp}" aria-label="WhatsApp" data-social="whatsapp" target="_blank">
        <div class="filled"></div>
        ${icons.whatsapp}
      </a>
    ...
    <li class="icon-content">
      <a href="mailto:${userData.contact.email}" aria-label="Email" data-social="email">
        <div class="filled"></div>
        ${icons.mail}
      </a>
