    ...
    <div class="projects-grid">
      ${h.map((e,a)=>`
        <div class="card reveal reveal-delay-${a%4+1}">
          ...
          <a href="${e.title.includes("Paniculas")?"#proyecto/paniculas":e.title.includes("Cloud")?"#proyecto/cloud":e.title.includes("DSS")?"#proyecto/dss":e.title.includes("TID")?"#proyecto/tid":e.title.includes("Computacional")?"#proyecto/ic":"#"}" class="card-link">
            Ver detalles
            ${i.arrow}
          </a>
        </div>
  ...
  <div class="project-page">
    <div class="container reveal">
      ...
      <header class="project-hero">
        ...
        <p class="modal-subtitle">Deep Learning | Algoritmos Genéticos | Optimización Combinatoria</p>
      </header>
      ...
      <div class="project-grid">
        <div class="project-main-content">
          <section>
            ...
            <p>Este proyecto explora la frontera entre el aprendizaje profundo y la optimización de sistemas complejos, resolviendo problemas de OCR y asignación cuadrática (QAP).</p>
          </section>

          <section>
            <h2>1. Reconocimiento Óptico (OCR) con CNN</h2>
            <p>Implementación de redes neuronales desde cero y mediante TensorFlow/Keras para clasificación de dígitos MNIST.</p>
            <div class="practice-grid">
              <div class="practice-card">
                <span class="practice-tag">ESTADO DEL ARTE</span>
                <h3>99.72% Accuracy</h3>
                <p>Modelo CNN optimizado con Batch Normalization, Dropout y AdamW. Solo 28 fallos en 10,000 imágenes.</p>
              </div>
              <div class="practice-card">
                <span class="practice-tag">ENGINEERING</span>
                <h3>Desde Cero</h3>
                <p>Implementación matemática de Forward/Backpropagation y optimización im2col con NumPy.</p>
              </div>
            </div>
            <ul class="learning-list">
              <li class="learning-item"><strong>Arquitecturas:</strong> MLP (4 capas), CNN (Extra extracción de características).</li>
              <li class="learning-item"><strong>Regularización:</strong> Batch Normalization, Dropout, Early Stopping.</li>
            </ul>
          </section>

          <section>
            <h2>2. Optimización Combinatoria (QAP)</h2>
            <p>Resolución de problemas NP-difíciles mediante Algoritmos Genéticos avanzados.</p>
            <div class="practice-grid">
              <div class="practice-card">
                <span class="practice-tag">ALGORÍTMICA</span>
                <h3>Evolución Híbrida</h3>
                <p>Comparación de estrategias Baldwinianas y Lamarckianas integradas con Simulated Annealing.</p>
              </div>
              <div class="practice-card">
                <span class="practice-tag">PERFORMANCE</span>
                <h3>Paralelismo</h3>
                <p>Uso de joblib para evaluación paralela de poblaciones y mutación adaptativa ante estancamientos.</p>
              </div>
            </div>
            <ul class="learning-list">
              <li class="learning-item"><strong>Operadores:</strong> Tournament Selection, Order Crossover (OX), Scramble Mutation.</li>
              <li class="learning-item"><strong>Búsqueda Local:</strong> Integración de heurísticas 2-opt y 3-opt.</li>
            </ul>
          </section>
...
`,v=()=>{const e=window.location.hash,a=document.querySelector("header");e==="#proyecto/paniculas"?(r.innerHTML=`
    ...
    `,a.style.display="none"):(r.innerHTML=`
      ...
      ${c()}
      ${$()}
    `,a.style.display="block",L(),E()),I(),window.scrollTo({top:0,behavior:"smooth"})};window.addEventListener("hashchange",v);document.addEventListener("DOMContentLoaded",()=>{v()});
