    ...
    <div class="projects-grid">
      ${g.map((e,a)=>`
        <div class="card reveal reveal-delay-${a%4+1}">
          ...
          <a href="${e.title.includes("Paniculas")?"#proyecto/paniculas":e.title.includes("Cloud")?"#proyecto/cloud":e.title.includes("DSS")?"#proyecto/dss":e.title.includes("TID")?"#proyecto/tid":"#"}" class="card-link">
            Ver detalles
            ${i.arrow}
          </a>
        </div>
      ...
      <div class="project-grid">
        <div class="project-main-content">
          <section>
            ...
            <p>Este proyecto abarca el ciclo completo de Data Science sobre datasets reales de finanzas, deporte, salud y mercados financieros, utilizando KNIME y Python.</p>
          </section>

          <section>
            <h2>1. Análisis Exploratorio & Preparación</h2>
            <p>Limpieza profunda y preprocesamiento de datos para maximizar el rendimiento del modelado.</p>
            <ul class="learning-list">
              <li class="learning-item"><strong>Técnicas:</strong> PCA (Dimensionality Reduction), SMOTE (Oversampling), Imputación predictiva.</li>
              <li class="learning-item"><strong>Visualización:</strong> Análisis multivariable con coordenadas paralelas y mapas de calor.</li>
            </ul>
          </section>

          <section>
            <h2>2. ML Supervisado & No Supervisado</h2>
            <p>Aplicación de algoritmos avanzados para clasificación, regresión y descubrimiento de patrones.</p>
            <ul class="learning-list">
              <li class="learning-item"><strong>Clustering:</strong> K-Means, DBSCAN y Jerárquico para segmentación de perfiles.</li>
              <li class="learning-item"><strong>Predicción:</strong> Random Forest, SVM y XGBoost para rendimiento deportivo y clínico.</li>
              <li class="learning-item"><strong>Minería:</strong> Algoritmo Apriori para análisis de cesta de la compra (Market Basket).</li>
            </ul>
          </section>

          <section>
            <h2>3. NLP & Series Temporales</h2>
            <p>Análisis de texto y predicción de datos financieros secuenciales.</p>
            <ul class="learning-list">
              <li class="learning-item"><strong>Sentimiento:</strong> Clasificación de reseñas IMDb usando TF-IDF y Bag of Words.</li>
              <li class="learning-item"><strong>Finanzas:</strong> Predicción del valor de Tesla (TSLA) con Regresión lineal y Transformada de Fourier para filtrado de ruido.</li>
            </ul>
          </section>
...
`,v=()=>{const e=window.location.hash,a=document.querySelector("header");e==="#proyecto/paniculas"?(c.innerHTML=`
      ${M()}
      ${l()}
    `,a.style.display="none"):e==="#proyecto/cloud"?(c.innerHTML=`
      ${I()}
      ${l()}
    `,a.style.display="none"):e==="#proyecto/dss"?(c.innerHTML=`
      ${D()}
      ${l()}
    `,a.style.display="none"):e==="#proyecto/tid"?(c.innerHTML=`
      ${z()}
      ${l()}
    `,a.style.display="none"):(c.innerHTML=`
      ...
      ${l()}
      ${L()}
    `,a.style.display="block",j(),P()),E(),window.scrollTo({top:0,behavior:"smooth"})};window.addEventListener("hashchange",v);document.addEventListener("DOMContentLoaded",()=>{v()});
