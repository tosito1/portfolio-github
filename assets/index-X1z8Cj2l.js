    ...
    <div class="projects-grid">
      ${u.map((e,i)=>`
        <div class="card reveal reveal-delay-${i%4+1}">
          ...
          <a href="${e.title.includes("Paniculas")?"#proyecto/paniculas":e.title.includes("Cloud")?"#proyecto/cloud":e.title.includes("DSS")?"#proyecto/dss":e.title.includes("TID")?"#proyecto/tid":e.title.includes("Computacional")?"#proyecto/ic":e.title.includes("Paquito")?"#proyecto/paquito":e.title.includes("Museo")?"#proyecto/museo":"#"}" class="card-link">
            Ver detalles
            ${a.arrow}
          </a>
        </div>
  ...
  <div class="project-page">
    <div class="container reveal">
      ...
      <header class="project-hero">
        ...
        <p class="modal-subtitle">Sistemas Software Basados en Web (SSBW) | Full-Stack Development</p>
      </header>

      <div class="project-grid">
        <div class="project-main-content">
          <section>
            <h2>Recreación Web Integral</h2>
            <p>Este proyecto representa una recreación completa del sitio web del Museo Arqueológico de Granada, abarcando desde la extracción de datos arqueológicos reales hasta la construcción de una infraestructura moderna.</p>
          </section>

          <div class="practice-grid">
            <div class="practice-card reveal">
              <span class="practice-tag">BACKEND</span>
              <h3>Node.js & Prisma</h3>
              <p>API RESTful robusta utilizando Express y **Prisma ORM**. Gestión de relaciones complejas en una DB relacional distribuida.</p>
            </div>
            
            <div class="practice-card reveal">
              <span class="practice-tag">INFRAESTRUCTURA</span>
              <h3>Dockerized DB</h3>
              <p>Entorno de desarrollo y base de datos **PostgreSQL** orquestados mediante contenedores Docker para consistencia total.</p>
            </div>

            <div class="practice-card reveal">
              <span class="practice-tag">QA & AUTOMATION</span>
              <h3>E2E Playwright</h3>
              <p>Ciclo de calidad completo con **Playwright**: desde el web scraping inicial para poblar el catálogo hasta pruebas de integración automáticas.</p>
            </div>

            <div class="practice-card reveal">
              <span class="practice-tag">SEGURIDAD</span>
              <h3>JWT & Cookies</h3>
              <p>Sistema de gestión de sesiones seguro con autenticación vía **JSON Web Tokens** y protección avanzada de rutas.</p>
            </div>
          </div>
          ...
          <section>
            ...
            <ul class="learning-list">
              <li class="learning-item"><strong>Frontend Templating:</strong> Uso de **Nunjucks** para un renderizado dinámico del lado del servidor altamente modular y eficiente.</li>
              <li class="learning-item"><strong>Logging Profesional:</strong> Implementación de trazabilidad completa del sistema mediante **Winston** para monitorización de errores.</li>
              <li class="learning-item"><strong>Scraping de Datos:</strong> Automatización de la captura de información de piezas arqueológicas para recrear el catálogo museístico.</li>
            </ul>
          </section>
          ...
          <div class="sidebar-card">
            ...
            <div class="tech-list-detailed">
              ...
              <div class="tech-item-detailed">
                ...
                <span>JS, Nunjucks, HTML5/CSS3</span>
              </div>
              <div class="tech-item-detailed">
              ...
              <div class="tech-item-detailed">
                ...
                <span>Playwright (E2E & Scraping)</span>
              </div>
            </div>
          </div>
...
`,v=()=>{const e=window.location.hash,i=document.querySelector("header");e==="#proyecto/paniculas"?(n.innerHTML=`
      ${x()}
      ${c()}
    ...
    `,i.style.display="none"):(n.innerHTML=`
      ...
      ${c()}
      ${E()}
    `,i.style.display="block",L(),I()),z(),window.scrollTo({top:0,behavior:"smooth"})};window.addEventListener("hashchange",v);document.addEventListener("DOMContentLoaded",()=>{v()});
