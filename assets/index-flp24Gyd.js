      ...
      <div class="project-grid">
        <div class="project-main-content">
          <section>
            ...
            <p>Este proyecto integra modelos de Deep Learning optimizados para hardware limitado, permitiendo que un robot hexápodo tome decisiones en tiempo real, reconozca su entorno y se comunique mediante lenguaje natural.</p>
          </section>

          <div class="practice-grid">
            <div class="practice-card reveal">
              <span class="practice-tag">COMPUTER VISION</span>
              <h3>Edge AI & TFLite</h3>
              <p>Detección de intrusos (99.8% precision) y clasificación de entorno para navegación segura. Modelos Keras cuantizados a <strong>.tflite</strong> para inferencia en tiempo real en Raspberry Pi.</p>
            </div>
            
            <div class="practice-card reveal">
              <span class="practice-tag">HCI</span>
              <h3>NLP con Whisper</h3>
              <p>Control por voz mediante el modelo <strong>Transformer Whisper</strong> de OpenAI. Procesamiento de audio en ventanas de 5s para decodificación de comandos complejos.</p>
            </div>

            <div class="practice-card reveal">
              <span class="practice-tag">INGENIERÍA</span>
              <h3>Sistemas Concurrentes</h3>
              <p>Arquitectura <strong>Multihilo</strong> en Python para sincronizar visión, audio y motores sin latencia. Comunicación bidireccional mediante <strong>Sockets TCP</strong>.</p>
            </div>

            <div class="practice-card reveal">
              <span class="practice-tag">CONTROL</span>
              <h3>Máquina de Estados</h3>
              <p>Lógica de navegación avanzada: Vigilancia Estática, Dinámica con evasión de obstáculos y Modo Reposo para eficiencia energética.</p>
            </div>
          </div>

          <section>
            <h2>1. Visión Artificial Avanzada</h2>
            <p>Se diseñaron dos redes neuronales críticas para la supervivencia del robot:</p>
            <ul class="learning-list">
              <li class="learning-item"><strong>Detección de Intrusos:</strong> Entrenamiento con 504 imágenes y <strong>Data Augmentation</strong> masivo. Corrección de sesgo mediante Data-centric AI para evitar falsos positivos con objetos rojos estáticos.</li>
              <li class="learning-item"><strong>Navegación Segura:</strong> CNN customizada (99.58% accuracy) para detectar bordes y evitar caídas, ejecutada en tflite-runtime.</li>
            </ul>
          </section>

          <section>
            <h2>2. Resolución de Conflictos Técnicos</h2>
            <div class="sidebar-card" style="margin: 2rem 0; width: 100%;">
              <h3>Ingeniería de Soluciones</h3>
              <p>Frente a la incompatibilidad de drivers entre Coral TPU (Python 3.9) y el sistema base (Python 3.11), se optó por una <strong>optimización matemática</strong> del código para CPU, logrando la velocidad necesaria sin hardware externo.</p>
              <p style="margin-top: 1rem;">Implementación de <strong>Hot-linking</strong> para binarios de FFmpeg, asegurando la portabilidad del modelo Whisper entre diferentes entornos.</p>
            </div>
          </section>
          ...
          <div class="sidebar-card">
            ...
            <div class="tech-list-detailed">
              ...
              <div class="tech-item-detailed">
                ...
                <span>Raspberry Pi, Motores Hexápodo</span>
              </div>
              <div class="tech-item-detailed">
                <strong>Software</strong>
                <span>Python, Threading, Sockets TCP</span>
              </div>
              <div class="tech-item-detailed">
                <strong>Librerías</strong>
                <span>NumPy, OpenCV, Sounddevice</span>
              </div>
            </div>
          </div>
...
`,g=()=>{const e=window.location.hash,i=document.querySelector("header");e==="#proyecto/paniculas"?(n.innerHTML=`
    ...
    `,i.style.display="none"):(n.innerHTML=`
      ...
      ${c()}
      ${I()}
    `,i.style.display="block",E(),L()),z(),window.scrollTo({top:0,behavior:"smooth"})};window.addEventListener("hashchange",g);document.addEventListener("DOMContentLoaded",()=>{g()});
