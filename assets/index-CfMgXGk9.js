...
`,v=()=>{const e=window.location.hash,a=document.querySelector("header");e==="#proyecto/paniculas"?(c.innerHTML=`
    ...
    `,a.style.display="none"):(c.innerHTML=`
      ...
      ${l()}
      ${P()}
    `,a.style.display="block",L(),j()),E(),window.scrollTo({top:0,behavior:"smooth"})};window.addEventListener("hashchange",v);document.addEventListener("DOMContentLoaded",()=>{v()});
