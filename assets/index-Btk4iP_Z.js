...
`,v=()=>{const e=window.location.hash,t=document.querySelector("header");e==="#proyecto/paniculas"?(l.innerHTML=`
      ${A()}
      ${d()}
    `,t.style.display="none"):(l.innerHTML=`
      ...
      ${d()}
      ${renderScrollTop()}
    `,t.style.display="block",createMobileMenu(),handleHeaderScroll()),initRevealAnimations(),window.scrollTo({top:0,behavior:"smooth"})};window.addEventListener("hashchange",v);document.addEventListener("DOMContentLoaded",()=>{v()});
