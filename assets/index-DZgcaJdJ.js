...
`,g=()=>{const e=window.location.hash,i=document.querySelector("header");e==="#proyecto/paniculas"?(n.innerHTML=`
    ...
    `,i.style.display="none"):(n.innerHTML=`
      ...
      ${c()}
      ${E()}
    `,i.style.display="block",I(),L()),j(),window.scrollTo({top:0,behavior:"smooth"})};window.addEventListener("hashchange",g);document.addEventListener("DOMContentLoaded",()=>{g()});
